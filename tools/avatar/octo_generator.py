...
def generate_octopus_image(body_rgb=(150, 150, 150),
    ...
    if   headgear == "grad":         draw.rectangle([22,17,42,20],fill=B); draw.polygon([(32,9),(44,14),(32,19),(20,14)],fill=B); draw.line([32,9,44,14],fill=(70,70,70,255),width=1); px[32,9]=GOLD; draw.line([44,14,46,18],fill=GOLD,width=1); draw.line([46,18,45,22],fill=GOLD,width=1); draw.line([46,18,46,22],fill=GOLD,width=1); draw.line([46,18,47,22],fill=GOLD,width=1)
    ...
    elif headgear == "ninja":        draw.rectangle([20,20,25,23],fill=(30,60,140,255)); draw.rectangle([39,20,44,23],fill=(30,60,140,255)); draw.rectangle([25,18,39,25],fill=(160,170,180,255)); draw.rectangle([25,18,39,25],outline=(80,90,100,255)); draw.line([28,21,36,21],fill=(80,90,100,255),width=1); draw.line([32,19,32,24],fill=(80,90,100,255),width=1)
    ...
    elif headgear == "ribbon":       draw.polygon([(22,14),(32,18),(22,22)],fill=RED); draw.polygon([(42,14),(32,18),(42,22)],fill=RED); draw.ellipse([29,16,35,20],fill=(200,40,40,255))
    ...
    elif headgear == "cowboy_hat":        draw.ellipse([18,19,46,23],fill=TAN,outline=(130,90,40,255)); draw.polygon([(18,21),(15,17),(18,19)],fill=TAN); draw.line([15,17,18,19],fill=(130,90,40,255),width=1); draw.polygon([(46,21),(49,17),(46,19)],fill=TAN); draw.line([49,17,46,19],fill=(130,90,40,255),width=1); draw.rectangle([24,10,40,20],fill=TAN); draw.chord([24,8,40,14],start=180,end=0,fill=TAN); draw.line([24,10,24,20],fill=(130,90,40,255),width=1); draw.line([40,10,40,20],fill=(130,90,40,255),width=1); draw.line([32,8,32,12],fill=(130,90,40,255),width=1); draw.rectangle([24,17,40,20],fill=(100,60,20,255)); px[32,18]=GOLD
    elif headgear == "cowboy_hat_brown":  draw.ellipse([18,19,46,23],fill=(140,90,45,255),outline=(80,45,10,255)); draw.polygon([(18,21),(15,17),(18,19)],fill=(140,90,45,255)); draw.line([15,17,18,19],fill=(80,45,10,255),width=1); draw.polygon([(46,21),(49,17),(46,19)],fill=(140,90,45,255)); draw.line([49,17,46,19],fill=(80,45,10,255),width=1); draw.rectangle([24,10,40,20],fill=(140,90,45,255)); draw.chord([24,8,40,14],start=180,end=0,fill=(140,90,45,255)); draw.line([24,10,24,20],fill=(80,45,10,255),width=1); draw.line([40,10,40,20],fill=(80,45,10,255),width=1); draw.line([32,8,32,12],fill=(80,45,10,255),width=1); draw.rectangle([24,17,40,20],fill=RED); px[32,18]=GOLD
    elif headgear == "kabuto":             draw.ellipse([21,13,43,25],fill=SILVER,outline=B); draw.rectangle([21,22,43,25],fill=(100,110,120,255)); draw.polygon([(19,20),(12,20),(10,35),(18,35)],fill=SILVER,outline=B); draw.line([11,26,18,26],fill=(170,180,190,255),width=1); draw.line([10,31,18,31],fill=(170,180,190,255),width=1); draw.polygon([(45,20),(52,20),(54,35),(46,35)],fill=SILVER,outline=B); draw.line([46,26,53,26],fill=(170,180,190,255),width=1); draw.line([46,31,54,31],fill=(170,180,190,255),width=1); draw.line([30,14,27,9],fill=GOLD,width=2); draw.line([34,14,37,9],fill=GOLD,width=2)
    elif headgear == "kabuto_red":         draw.ellipse([21,13,43,25],fill=RED,outline=B); draw.rectangle([21,22,43,25],fill=GOLD); draw.polygon([(19,20),(12,20),(10,35),(18,35)],fill=RED,outline=B); draw.line([11,26,18,26],fill=(180,40,40,255),width=1); draw.line([10,31,18,31],fill=(180,40,40,255),width=1); draw.polygon([(45,20),(52,20),(54,35),(46,35)],fill=RED,outline=B); draw.line([46,26,53,26],fill=(180,40,40,255),width=1); draw.line([46,31,54,31],fill=(180,40,40,255),width=1); draw.arc([28,8,36,16],start=0,end=180,fill=GOLD,width=2)
    elif headgear == "kabuto_black":       draw.ellipse([21,13,43,25],fill=B,outline=(60,60,60,255)); draw.rectangle([21,22,43,25],fill=SILVER); draw.polygon([(19,20),(12,20),(10,35),(18,35)],fill=B,outline=(60,60,60,255)); draw.line([11,26,18,26],fill=(70,70,70,255),width=1); draw.line([10,31,18,31],fill=(70,70,70,255),width=1); draw.polygon([(45,20),(52,20),(54,35),(46,35)],fill=B,outline=(60,60,60,255)); draw.line([46,26,53,26],fill=(70,70,70,255),width=1); draw.line([46,31,54,31],fill=(70,70,70,255),width=1); draw.line([30,14,27,9],fill=SILVER,width=2); draw.line([34,14,37,9],fill=SILVER,width=2); draw.line([26,18,38,18],fill=RED,width=1)
    elif headgear == "cap":          draw.chord([24,10,40,20],start=180,end=0,fill=BLUE); draw.rectangle([24,17,40,19],fill=(30,80,160,255)); draw.rectangle([31,9,33,11],fill=(30,80,160,255)); draw.rectangle([18,17,26,18],fill=(30,80,160,255))
    elif headgear == "cap_red":          draw.chord([24,10,40,20],start=180,end=0,fill=RED); draw.rectangle([24,17,40,19],fill=(180,30,30,255)); draw.rectangle([31,9,33,11],fill=(180,30,30,255)); draw.rectangle([18,17,26,18],fill=(180,30,30,255))
    elif headgear == "cap_black":        draw.chord([24,10,40,20],start=180,end=0,fill=(60,60,60,255)); draw.rectangle([24,17,40,19],fill=(30,30,30,255)); draw.rectangle([31,9,33,11],fill=(30,30,30,255)); draw.rectangle([18,17,26,18],fill=(30,30,30,255))
    elif headgear == "hard_hat":     draw.ellipse([19,16,45,21],fill=YELLOW); draw.ellipse([24,10,40,20],fill=YELLOW)
    elif headgear == "beret":        draw.ellipse([22,12,40,18],fill=RED); draw.rectangle([30,10,32,12],fill=(160,20,20,255))
    elif headgear == "pirate":       draw.polygon([(18,18),(20,13),(26,18)],fill=B); draw.polygon([(46,18),(44,13),(38,18)],fill=B); draw.rectangle([24,10,40,18],fill=B); draw.rectangle([20,17,44,19],fill=B); draw.ellipse([29,11,35,16],fill=W); draw.rectangle([30,13,31,13],fill=B); draw.rectangle([33,13,34,13],fill=B); draw.line([30,15,34,15],fill=B,width=1)
    ...
    elif headgear == "jester":       draw.rectangle([20,16,44,19],fill=GOLD); draw.chord([22,9,42,21],start=180,end=0,fill=RED); draw.polygon([(32,19),(32,11),(37,9),(42,11),(42,19)],fill=BLUE); draw.polygon([(20,15),(26,15),(14,23),(10,23)],fill=RED); draw.polygon([(38,15),(44,15),(54,23),(50,23)],fill=BLUE); draw.ellipse([7,21,14,28],fill=GOLD); draw.ellipse([50,21,57,28],fill=GOLD)
    elif headgear == "sombrero":     draw.ellipse([14,16,50,20],fill=GREEN); draw.polygon([(26,16),(32,6),(38,16)],fill=GREEN); draw.line([28,14,36,14],fill=RED); [[draw.line([x,20,x,21],fill=YELLOW,width=1),draw.point((x,22),fill=ORANGE)] for x in range(15,50,4)]
    ...
    elif headgear == "cherry":       draw.ellipse([24,13,30,19],fill=RED); draw.ellipse([34,13,40,19],fill=RED); draw.line([32,8,32,12],fill=(30,130,70,255),width=1); draw.line([32,12,27,13],fill=(30,130,70,255),width=1); draw.line([32,12,37,13],fill=(30,130,70,255),width=1); draw.ellipse([31,6,36,10],fill=GREEN)
    elif headgear == "mushroom":     draw.ellipse([22,7,42,17],fill=RED); draw.ellipse([26,9,30,13],fill=W); draw.ellipse([34,11,38,15],fill=W); draw.rectangle([28,17,36,19],fill=W)
    elif headgear == "shiitake":     draw.ellipse([20,11,44,18],fill=(75,45,20,255)); draw.ellipse([25,9,39,15],fill=(75,45,20,255)); draw.ellipse([27,10,37,14],fill=(58,34,12,255)); draw.rectangle([28,17,36,19],fill=TAN)

    elif headgear == "ice_crown":    draw.polygon([(24,18),(24,10),(28,14),(32,8),(36,14),(40,10),(40,18)],fill=SKY); [draw.line([32,13,32,10],fill=W,width=1),draw.line([32,13,35,12],fill=W,width=1),draw.line([32,13,35,14],fill=W,width=1),draw.line([32,13,32,16],fill=W,width=1),draw.line([32,13,29,14],fill=W,width=1),draw.line([32,13,29,12],fill=W,width=1),draw.line([31,11,33,11],fill=W,width=1),draw.line([34,13,34,12],fill=W,width=1),draw.line([30,13,30,12],fill=W,width=1),draw.line([31,15,33,15],fill=W,width=1)]
    ...
    elif headgear == "headphones":   draw.arc([16,17,48,35],start=180,end=0,fill=B,width=3); draw.ellipse([13,26,19,34],fill=B); draw.ellipse([45,26,51,34],fill=B); draw.ellipse([14,27,18,33],fill=(80,80,80,255)); draw.ellipse([46,27,50,33],fill=(80,80,80,255))
    elif headgear == "antenna":      draw.line([32,18,32,8],fill=SILVER,width=1); draw.ellipse([30,6,34,10],fill=RED)
    elif headgear == "bunny_ears":   draw.arc([19,16,45,48],start=207,end=333,fill=W,width=3); draw.polygon([(22,21),(22,9),(25,4),(27,9),(27,19)],fill=W); draw.polygon([(42,21),(42,9),(39,4),(37,9),(37,19)],fill=W); draw.polygon([(23,19),(23,10),(25,6),(26,10),(26,19)],fill=PINK); draw.polygon([(41,19),(41,10),(39,6),(38,10),(38,19)],fill=PINK)
    elif headgear == "bear_ears":    draw.arc([14,18,50,54],start=225,end=315,fill=(140,90,50,255),width=2); draw.ellipse([19,15,27,21],fill=(165,110,65,255)); draw.ellipse([37,15,45,21],fill=(165,110,65,255)); draw.ellipse([21,16,25,20],fill=(215,170,115,255)); draw.ellipse([39,16,43,20],fill=(215,170,115,255))
    elif headgear == "bucket_hat":   draw.ellipse([14,18,50,26],fill=TAN); draw.rectangle([22,12,42,19],fill=TAN); draw.ellipse([22,10,42,13],fill=TAN); draw.rectangle([22,11,42,12],fill=TAN); draw.rectangle([22,16,42,17],fill=(160,130,100,255))
    ...
    def draw_handheld(item_type, side):
        ...
        if   item_type=="flower":        draw.line([_cx,_cy,_cx,_cy+6],fill=GREEN); draw.point((_cx-1,_cy+3),fill=GREEN); draw.ellipse([_cx-3,_cy-5,_cx+3,_cy+1],fill=RED); px[_cx,_cy-2]=YELLOW; px[_cx-2,_cy-4]=PINK; px[_cx+2,_cy-4]=PINK
        ...
        elif item_type=="wand":          draw.line([_cx,_cy-8,_cx,_cy+8],fill=BROWN,width=1); draw.line([_cx-3,_cy-11,_cx+3,_cy-11],fill=GOLD,width=1); draw.line([_cx,_cy-14,_cx,_cy-8],fill=GOLD,width=1); px[_cx-2,_cy-13]=GOLD; px[_cx+2,_cy-13]=GOLD; px[_cx-2,_cy-9]=GOLD; px[_cx+2,_cy-9]=GOLD; px[_cx,_cy-11]=W
        elif item_type=="chinese_lantern": draw.line([_cx,_cy-6,_cx,_cy-3],fill=B,width=1); draw.rectangle([_cx-1,_cy-4,_cx+1,_cy-3],fill=GOLD); draw.polygon([(_cx-3,_cy-3),(_cx+3,_cy-3),(_cx+5,_cy),(_cx+5,_cy+4),(_cx+3,_cy+6),(_cx-3,_cy+6),(_cx-5,_cy+4),(_cx-5,_cy)],fill=RED,outline=B); draw.line([_cx-5,_cy+2,_cx+5,_cy+2],fill=GOLD,width=1); px[_cx,_cy+3]=(255,180,100,255); draw.line([_cx,_cy+6,_cx,_cy+10],fill=ORANGE); draw.line([_cx-1,_cy+7,_cx-1,_cy+10],fill=RED); draw.line([_cx+1,_cy+7,_cx+1,_cy+10],fill=RED)
        elif item_type=="candle_lantern": draw.arc([_cx-3,_cy-11,_cx+3,_cy-6],180,360,fill=(42,42,48,255),width=2); draw.line([_cx-3,_cy-9,_cx-3,_cy-7],fill=(42,42,48,255),width=1); draw.line([_cx+3,_cy-9,_cx+3,_cy-7],fill=(42,42,48,255),width=1); draw.rectangle([_cx-3,_cy-7,_cx+3,_cy-6],fill=(42,42,48,255)); draw.ellipse([_cx-4,_cy-6,_cx+4,_cy+5],fill=(155,208,232,185)); draw.ellipse([_cx-3,_cy-5,_cx-1,_cy-3],fill=(205,238,250,200)); draw.point([(_cx-4,_cy-5),(_cx+4,_cy-5),(_cx-4,_cy+4),(_cx+4,_cy+4)],fill=(42,42,48,255)); draw.ellipse([_cx-1,_cy-5,_cx+1,_cy-2],fill=(255,220,35,255)); draw.ellipse([_cx-2,_cy-3,_cx+2,_cy+1],fill=(238,105,28,255)); draw.ellipse([_cx-1,_cy,_cx+1,_cy+2],fill=(195,52,15,255)); draw.line([_cx,_cy+2,_cx,_cy+3],fill=(55,40,22,255),width=1); draw.rectangle([_cx-2,_cy+3,_cx+2,_cy+5],fill=(82,70,52,255)); draw.line([_cx-2,_cy+3,_cx+2,_cy+3],fill=(115,100,75,255),width=1); draw.rectangle([_cx-3,_cy+5,_cx+3,_cy+6],fill=(42,42,48,255)); draw.rectangle([_cx-3,_cy+6,_cx+3,_cy+8],fill=(42,42,48,255)); draw.rectangle([_cx-4,_cy+8,_cx+4,_cy+9],fill=(42,42,48,255))
        elif item_type=="book":          draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=BROWN); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=RED,outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=YELLOW)
        elif item_type=="book_blue":     draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=(30,50,120,255)); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=BLUE,outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=GOLD); draw.ellipse([_cx+1,_cy-1,_cx+4,_cy+2],fill=SILVER); px[_cx+2,_cy]=W
        elif item_type=="book_magic":    draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=(90,40,140,255)); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=PURPLE,outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=GOLD); px[_cx+2,_cy-2]=GOLD; px[_cx+1,_cy-1]=GOLD; px[_cx+3,_cy-1]=GOLD; px[_cx,_cy]=GOLD; px[_cx+2,_cy]=GOLD; px[_cx+4,_cy]=GOLD; px[_cx+1,_cy+1]=GOLD; px[_cx+3,_cy+1]=GOLD; px[_cx+2,_cy+2]=GOLD; px[_cx+2,_cy-1]=W
        elif item_type=="journal":       draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=(100,60,20,255)); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=(180,130,70,255),outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=RED); draw.rectangle([_cx-2,_cy-6,_cx-1,_cy-5],fill=(100,60,20,255)); draw.rectangle([_cx+4,_cy-6,_cx+5,_cy-5],fill=(100,60,20,255)); draw.rectangle([_cx-2,_cy+5,_cx-1,_cy+6],fill=(100,60,20,255)); draw.rectangle([_cx+4,_cy+5,_cx+5,_cy+6],fill=(100,60,20,255))
        elif item_type=="textbook":      draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=(40,100,40,255)); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=GREEN,outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=YELLOW); draw.rectangle([_cx-1,_cy-4,_cx+4,_cy-2],fill=W); draw.line([_cx,_cy-3,_cx+3,_cy-3],fill=(160,160,160,255))
        elif item_type=="book_pink":     draw.rectangle([_cx-5,_cy-6,_cx-2,_cy+6],fill=(200,80,120,255)); draw.rectangle([_cx-2,_cy-6,_cx+5,_cy+6],fill=PINK,outline=B); draw.line([_cx+5,_cy-5,_cx+5,_cy+5],fill=TAN); draw.line([_cx+4,_cy-5,_cx+4,_cy+5],fill=(230,200,160,255)); draw.rectangle([_cx+2,_cy-7,_cx+3,_cy-4],fill=PURPLE); px[_cx+1,_cy-1]=W; px[_cx+3,_cy-1]=W; px[_cx+2,_cy]=W; px[_cx+1,_cy]=W; px[_cx+3,_cy]=W; px[_cx+2,_cy+1]=W
        ...
        elif item_type=="balloon":       draw.ellipse([_cx-5,_cy-11,_cx+5,_cy-1],fill=RED); draw.polygon([(_cx-1,_cy-1),(_cx+1,_cy-1),(_cx,_cy+1)],fill=RED); draw.line([_cx,_cy+1,_cx,_cy+6],fill=B)
        elif item_type=="magnifier":     draw.line([_cx,_cy,_cx,_cy+7],fill=BROWN,width=2); draw.ellipse([_cx-4,_cy-8,_cx+4,_cy],outline=(180,150,30,255),width=2); draw.ellipse([_cx-3,_cy-7,_cx+3,_cy-1],fill=(175,220,255,255)); px[_cx-2,_cy-6]=W; px[_cx-2,_cy-5]=W
        elif item_type=="bow":
            _s = 1 if side=='r' else -1
            if side=='r': draw.arc([_cx-8,_cy-8,_cx+2,_cy+8],start=270,end=90,fill=BROWN,width=2)
            else:         draw.arc([_cx-2,_cy-8,_cx+8,_cy+8],start=90,end=270,fill=BROWN,width=2)
            draw.line([_cx-3*_s,_cy-8,_cx-3*_s,_cy+8],fill=W)
            draw.line([_cx-8*_s,_cy,_cx+3*_s,_cy],fill=SILVER)
            draw.polygon([(_cx+3*_s,_cy-2),(_cx+7*_s,_cy),(_cx+3*_s,_cy),(_cx+3*_s,_cy+2)],fill=SILVER,outline=B)
        elif item_type=="spear":         draw.line([_cx,_cy-9,_cx,_cy+10],fill=BROWN,width=2); draw.polygon([(_cx-3,_cy-9),(_cx,_cy-21),(_cx+3,_cy-9)],fill=SILVER); draw.line([_cx,_cy-19,_cx,_cy-10],fill=(230,235,240,255),width=1); draw.line([_cx-2,_cy-10,_cx-2,_cy-16],fill=B,width=1); draw.rectangle([_cx-2,_cy-10,_cx+2,_cy-9],fill=(150,155,160,255))
        elif item_type=="crystal_ball":  draw.polygon([(_cx-4,_cy+6),(_cx+4,_cy+6),(_cx,_cy+2)],fill=GOLD,outline=B); draw.ellipse([_cx-4,_cy-6,_cx+4,_cy+2],fill=(160,80,240,255),outline=(200,150,255,255)); px[_cx-1,_cy-4]=W; px[_cx+1,_cy-5]=W
        ...
        elif item_type=="medal":         draw.polygon([(_cx-3,_cy-8),(_cx+3,_cy-8),(_cx+2,_cy-2),(_cx-2,_cy-2)],fill=BLUE); [px.__setitem__((_cx,y),(180,150,30,255)) for y in range(_cy-7,_cy-1)]; draw.rectangle([_cx-3,_cy-9,_cx+3,_cy-8],fill=(180,150,30,255)); draw.ellipse([_cx-4,_cy-2,_cx+4,_cy+5],fill=GOLD,outline=(180,150,30,255)); draw.ellipse([_cx-2,_cy,_cx+2,_cy+3],fill=(255,240,120,255)); px.__setitem__((_cx,_cy+1),(255,255,255,255))
        elif item_type=="medal_star":    draw.line([_cx-2,_cy-8,_cx,_cy-2],fill=RED,width=2); draw.line([_cx+2,_cy-8,_cx,_cy-2],fill=BLUE,width=2); draw.ellipse([_cx-4,_cy-2,_cx+4,_cy+6],fill=GOLD,outline=B); px.__setitem__((_cx,_cy-1),W); px.__setitem__((_cx-2,_cy+1),W); px.__setitem__((_cx-1,_cy+1),W); px.__setitem__((_cx,_cy+1),W); px.__setitem__((_cx+1,_cy+1),W); px.__setitem__((_cx+2,_cy+1),W); px.__setitem__((_cx-1,_cy+3),W); px.__setitem__((_cx+1,_cy+3),W); px.__setitem__((_cx,_cy+4),W)
        elif item_type=="bell":          draw.rectangle([_cx-1,_cy-2,_cx+1,_cy+2],fill=BROWN); draw.polygon([(_cx-4,_cy+8),(_cx+4,_cy+8),(_cx+2,_cy+2),(_cx-2,_cy+2)],fill=GOLD,outline=B); draw.point([_cx,_cy+9],fill=B)
        ...
        elif item_type=="coffee_cup":   draw.rectangle([_cx-4,_cy-5,_cx+3,_cy+5],fill=(245,235,210,255),outline=B); draw.rectangle([_cx-3,_cy-4,_cx+2,_cy-3],fill=(90,55,30,255)); draw.arc([_cx+2,_cy-2,_cx+6,_cy+2],start=270,end=90,fill=B,width=1); draw.line([_cx-4,_cy+1,_cx+3,_cy+1],fill=(200,190,180,255),width=1)
        elif item_type=="onigiri":
            RICE_=(245,240,220,255); NORI_=(20,35,15,255)
            draw.polygon([(_cx,_cy-8),(_cx+2,_cy-7),(_cx+5,_cy-4),(_cx+7,_cy),(_cx+6,_cy+4),(_cx-6,_cy+4),(_cx-7,_cy),(_cx-5,_cy-4),(_cx-2,_cy-7)],fill=RICE_)
            draw.rectangle([_cx-2,_cy-1,_cx+2,_cy+4],fill=NORI_)
        elif item_type=="lollipop":
            draw.line([_cx,_cy-1,_cx,_cy+8],fill=(139,90,43,255),width=1)
            draw.ellipse([_cx-4,_cy-8,_cx+4,_cy],fill=(255,160,200,255))
            draw.arc([_cx-3,_cy-7,_cx+1,_cy-3],start=0,end=180,fill=(255,100,160,255),width=2)
            draw.arc([_cx,_cy-5,_cx+3,_cy-1],start=180,end=360,fill=(255,100,160,255),width=2)
            px[_cx-1,_cy-6]=W
        elif item_type=="gift_box_red":
            _B=(210,50,50,255); _R=(255,210,0,255); _L=(230,80,80,255)
            draw.rectangle([_cx-5,_cy-2,_cx+5,_cy+6],fill=_B)
            draw.rectangle([_cx-5,_cy-4,_cx+5,_cy-1],fill=_L)
            draw.line([_cx,_cy-4,_cx,_cy+6],fill=_R,width=2)
            draw.line([_cx-5,_cy+1,_cx+5,_cy+1],fill=_R,width=2)
            draw.ellipse([_cx-3,_cy-7,_cx-1,_cy-4],fill=_R)
            draw.ellipse([_cx+1,_cy-7,_cx+3,_cy-4],fill=_R)
        elif item_type=="gift_box_purple":
            _B=(140,80,200,255); _R=(255,140,180,255); _L=(160,100,220,255)
            draw.rectangle([_cx-5,_cy-2,_cx+5,_cy+6],fill=_B)
            draw.rectangle([_cx-5,_cy-4,_cx+5,_cy-1],fill=_L)
            draw.line([_cx,_cy-4,_cx,_cy+6],fill=_R,width=2)
            draw.line([_cx-5,_cy+1,_cx+5,_cy+1],fill=_R,width=2)
            draw.ellipse([_cx-3,_cy-7,_cx-1,_cy-4],fill=_R)
            draw.ellipse([_cx+1,_cy-7,_cx+3,_cy-4],fill=_R)
        elif item_type=="gift_box_blue":
            _B=(50,130,210,255); _R=(255,220,50,255); _L=(80,160,230,255)
            draw.rectangle([_cx-5,_cy-2,_cx+5,_cy+6],fill=_B)
            draw.rectangle([_cx-5,_cy-4,_cx+5,_cy-1],fill=_L)
            draw.line([_cx,_cy-4,_cx,_cy+6],fill=_R,width=2)
            draw.line([_cx-5,_cy+1,_cx+5,_cy+1],fill=_R,width=2)
            draw.ellipse([_cx-3,_cy-7,_cx-1,_cy-4],fill=_R)
            draw.ellipse([_cx+1,_cy-7,_cx+3,_cy-4],fill=_R)
        elif item_type=="potion_purple":
            _G=(210,235,255,255); _K=(180,140,80,255); _Q=(160,80,240,255)
            draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-6],fill=_K)
            draw.rectangle([_cx-1,_cy-6,_cx+1,_cy-3],fill=_G)
            draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+5],fill=_G)
            draw.ellipse([_cx-3,_cy-1,_cx+3,_cy+4],fill=_Q)
            px[_cx-2,_cy-3]=W
        elif item_type=="potion_red":
            _G=(210,235,255,255); _K=(180,140,80,255); _Q=(220,50,80,255)
            draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-6],fill=_K)
            draw.rectangle([_cx-1,_cy-6,_cx+1,_cy-3],fill=_G)
            draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+5],fill=_G)
            draw.ellipse([_cx-3,_cy-1,_cx+3,_cy+4],fill=_Q)
            px[_cx-2,_cy-3]=W
        elif item_type=="potion_green":
            _G=(210,235,255,255); _K=(180,140,80,255); _Q=(60,200,80,255)
            draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-6],fill=_K)
            draw.rectangle([_cx-1,_cy-6,_cx+1,_cy-3],fill=_G)
            draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+5],fill=_G)
            draw.ellipse([_cx-3,_cy-1,_cx+3,_cy+4],fill=_Q)
            px[_cx-2,_cy-3]=W
        elif item_type=="camera_a":    _BD=(55,60,70,255); _LO=(100,105,115,255); _LI=(20,25,40,255); draw.rectangle([_cx-5,_cy-3,_cx+5,_cy+4],fill=_BD); draw.rectangle([_cx-2,_cy-5,_cx,_cy-3],fill=_BD); draw.ellipse([_cx-3,_cy-2,_cx+3,_cy+3],fill=_LO); draw.ellipse([_cx-2,_cy-1,_cx+2,_cy+2],fill=_LI); px[_cx-1,_cy-1]=(200,220,255,255); draw.rectangle([_cx+2,_cy-5,_cx+4,_cy-4],fill=YELLOW)
        elif item_type=="camera_b":    _BD=(215,205,185,255); _TR=(70,65,55,255); _LI=(30,30,50,255); draw.rectangle([_cx-5,_cy-3,_cx+5,_cy+4],fill=_BD); draw.rectangle([_cx-3,_cy-5,_cx+3,_cy-3],fill=_BD); draw.rectangle([_cx-5,_cy-3,_cx+5,_cy-2],fill=_TR); draw.ellipse([_cx-3,_cy-2,_cx+3,_cy+3],fill=_TR); draw.ellipse([_cx-2,_cy-1,_cx+2,_cy+2],fill=_LI); px[_cx-1,_cy-1]=W; draw.rectangle([_cx+3,_cy-5,_cx+4,_cy-4],fill=(180,50,50,255))
        elif item_type=="camera_c":    _BD=(170,175,180,255); _GR=(60,60,65,255); _LO=(80,82,90,255); _LI=(20,22,35,255); draw.rectangle([_cx-5,_cy-4,_cx+5,_cy+5],fill=_BD); draw.rectangle([_cx-5,_cy-4,_cx-2,_cy+5],fill=_GR); draw.ellipse([_cx-2,_cy-3,_cx+4,_cy+3],fill=_LO); draw.ellipse([_cx-1,_cy-2,_cx+3,_cy+2],fill=_LI); px[_cx,_cy-1]=W; draw.rectangle([_cx+2,_cy-5,_cx+4,_cy-4],fill=(200,80,80,255))
        elif item_type=="fan_a":         draw.pieslice([_cx-8,_cy-4,_cx+8,_cy+12],start=210,end=330,fill=(220,50,50,255)); draw.line([_cx,_cy+4,_cx-7,_cy],fill=YELLOW,width=1); draw.line([_cx,_cy+4,_cx-4,_cy-3],fill=YELLOW,width=1); draw.line([_cx,_cy+4,_cx,_cy-4],fill=YELLOW,width=1); draw.line([_cx,_cy+4,_cx+4,_cy-3],fill=YELLOW,width=1); draw.line([_cx,_cy+4,_cx+7,_cy],fill=YELLOW,width=1)
        elif item_type=="fan_b":         draw.pieslice([_cx-8,_cy-4,_cx+8,_cy+12],start=210,end=330,fill=(80,140,210,255)); draw.line([_cx,_cy+4,_cx-7,_cy],fill=W,width=1); draw.line([_cx,_cy+4,_cx-4,_cy-3],fill=W,width=1); draw.line([_cx,_cy+4,_cx,_cy-4],fill=W,width=1); draw.line([_cx,_cy+4,_cx+4,_cy-3],fill=W,width=1); draw.line([_cx,_cy+4,_cx+7,_cy],fill=W,width=1)
        elif item_type=="fan_c":         draw.pieslice([_cx-8,_cy-4,_cx+8,_cy+12],start=210,end=330,fill=(255,160,190,255)); draw.line([_cx,_cy+4,_cx-7,_cy],fill=(200,80,120,255),width=1); draw.line([_cx,_cy+4,_cx-4,_cy-3],fill=(200,80,120,255),width=1); draw.line([_cx,_cy+4,_cx,_cy-4],fill=(200,80,120,255),width=1); draw.line([_cx,_cy+4,_cx+4,_cy-3],fill=(200,80,120,255),width=1); draw.line([_cx,_cy+4,_cx+7,_cy],fill=(200,80,120,255),width=1); px[_cx-3,_cy-2]=W; px[_cx+3,_cy-2]=W
        elif item_type=="donut_a":
            draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=(210,165,90,255))
            draw.chord([_cx-4,_cy-5,_cx+4,_cy],start=180,end=0,fill=(255,160,200,255))
            px[_cx-1,_cy-4]=(255,220,80,255); px[_cx+1,_cy-4]=(100,210,120,255); px[_cx+3,_cy-3]=(100,160,255,255); px[_cx-3,_cy-3]=(255,100,100,255)
            draw.ellipse([_cx-2,_cy-2,_cx+2,_cy+2],fill=(0,0,0,0))
        elif item_type=="donut_b":
            draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=(210,165,90,255))
            draw.chord([_cx-4,_cy-5,_cx+4,_cy],start=180,end=0,fill=(100,55,20,255))
            px[_cx-1,_cy-4]=(255,220,80,255); px[_cx+1,_cy-4]=(255,160,200,255); px[_cx+3,_cy-3]=(100,210,120,255); px[_cx-3,_cy-3]=(100,160,255,255)
            draw.ellipse([_cx-2,_cy-2,_cx+2,_cy+2],fill=(0,0,0,0))
        elif item_type=="donut_c":
            draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=(210,165,90,255))
            draw.chord([_cx-4,_cy-5,_cx+4,_cy],start=180,end=0,fill=(120,180,80,255))
            px[_cx-1,_cy-4]=W; px[_cx+1,_cy-4]=W; px[_cx+3,_cy-3]=W; px[_cx-3,_cy-3]=W
            draw.ellipse([_cx-2,_cy-2,_cx+2,_cy+2],fill=(0,0,0,0))
        elif item_type=="brush_a":       draw.polygon([(_cx-2,_cy-4),(_cx+2,_cy-4),(_cx,_cy-9)],fill=(25,20,15,255)); draw.rectangle([_cx-2,_cy-4,_cx+2,_cy-2],fill=(180,185,190,255)); draw.rectangle([_cx-1,_cy-2,_cx+1,_cy+8],fill=(175,140,75,255)); draw.line([_cx-1,_cy+1,_cx+1,_cy+1],fill=(140,110,55,255))
        elif item_type=="microphone":     draw.ellipse([_cx-2,_cy-7,_cx+2,_cy-2],fill=(60,65,70,255)); draw.line([_cx-1,_cy-6,_cx+1,_cy-6],fill=(95,100,105,255),width=1); draw.line([_cx-1,_cy-4,_cx+1,_cy-4],fill=(95,100,105,255),width=1); draw.rectangle([_cx-2,_cy-2,_cx+2,_cy-1],fill=(180,185,190,255)); draw.rectangle([_cx-1,_cy-1,_cx+1,_cy+7],fill=(50,55,60,255))
        elif item_type=="dumbbell":      draw.polygon([(_cx-4,_cy-6),(_cx+4,_cy-6),(_cx+5,_cy-5),(_cx+5,_cy-4),(_cx+4,_cy-3),(_cx-4,_cy-3),(_cx-5,_cy-4),(_cx-5,_cy-5)],fill=(75,75,75,255),outline=B); draw.line([_cx-3,_cy-6,_cx,_cy-6],fill=(170,170,170,255),width=1); draw.rectangle([_cx-1,_cy-3,_cx+1,_cy+3],fill=(130,130,130,255)); draw.polygon([(_cx-4,_cy+3),(_cx+4,_cy+3),(_cx+5,_cy+4),(_cx+5,_cy+5),(_cx+4,_cy+6),(_cx-4,_cy+6),(_cx-5,_cy+5),(_cx-5,_cy+4)],fill=(75,75,75,255),outline=B); draw.line([_cx-3,_cy+3,_cx,_cy+3],fill=(170,170,170,255),width=1)
        elif item_type=="candy":         draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=W); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=(230,60,60,255)); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=W,width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=W,width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=W)
        elif item_type=="candy_purple":  draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=(255,160,200,255)); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=(150,70,200,255)); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=(255,160,200,255),width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=(255,160,200,255),width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=(255,160,200,255))
        elif item_type=="candy_orange":  draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=W); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=(255,150,50,255)); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=W,width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=W,width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=W)
        elif item_type=="candy_blue":    draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=W); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=BLUE); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=W,width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=W,width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=W)
        elif item_type=="candy_pink":    draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=W); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=(255,120,160,255)); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=W,width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=W,width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=W)
        elif item_type=="candy_yellow":  draw.polygon([(_cx-8,_cy-3),(_cx-8,_cy+3),(_cx-4,_cy+1),(_cx-4,_cy-1)],fill=(255,140,30,255)); draw.ellipse([_cx-4,_cy-3,_cx+4,_cy+3],fill=(255,220,50,255)); draw.line([_cx-3,_cy+2,_cx+2,_cy-2],fill=(255,140,30,255),width=1); draw.line([_cx-1,_cy+3,_cx+4,_cy-1],fill=(255,140,30,255),width=1); draw.polygon([(_cx+4,_cy-1),(_cx+4,_cy+1),(_cx+8,_cy+3),(_cx+8,_cy-3)],fill=(255,140,30,255))
        elif item_type=="alarm_clock":        draw.ellipse([_cx-5,_cy-10,_cx-1,_cy-6],fill=SILVER,outline=B); draw.ellipse([_cx+1,_cy-10,_cx+5,_cy-6],fill=SILVER,outline=B); draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-7],fill=B); draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=SILVER,outline=B); draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+4],fill=W); px[_cx,_cy-3]=B; px[_cx+3,_cy]=B; px[_cx,_cy+3]=B; px[_cx-3,_cy]=B; draw.line([_cx,_cy,_cx-2,_cy+2],fill=B,width=1); draw.line([_cx,_cy,_cx,_cy-3],fill=RED,width=1); draw.line([_cx-4,_cy+5,_cx-5,_cy+7],fill=SILVER,width=1); draw.line([_cx+4,_cy+5,_cx+5,_cy+7],fill=SILVER,width=1)
        elif item_type=="alarm_clock_yellow": draw.ellipse([_cx-5,_cy-10,_cx-1,_cy-6],fill=(255,120,160,255),outline=B); draw.ellipse([_cx+1,_cy-10,_cx+5,_cy-6],fill=(255,120,160,255),outline=B); draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-7],fill=B); draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=YELLOW,outline=B); draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+4],fill=W); px[_cx,_cy-3]=B; px[_cx+3,_cy]=B; px[_cx,_cy+3]=B; px[_cx-3,_cy]=B; draw.line([_cx,_cy,_cx-2,_cy+2],fill=B,width=1); draw.line([_cx,_cy,_cx,_cy-3],fill=RED,width=1); draw.line([_cx-4,_cy+5,_cx-5,_cy+7],fill=YELLOW,width=1); draw.line([_cx+4,_cy+5,_cx+5,_cy+7],fill=YELLOW,width=1)
        elif item_type=="alarm_clock_red":    draw.ellipse([_cx-5,_cy-10,_cx-1,_cy-6],fill=GOLD,outline=B); draw.ellipse([_cx+1,_cy-10,_cx+5,_cy-6],fill=GOLD,outline=B); draw.rectangle([_cx-1,_cy-8,_cx+1,_cy-7],fill=B); draw.ellipse([_cx-5,_cy-5,_cx+5,_cy+5],fill=RED,outline=B); draw.ellipse([_cx-4,_cy-4,_cx+4,_cy+4],fill=W); px[_cx,_cy-3]=GOLD; px[_cx+3,_cy]=GOLD; px[_cx,_cy+3]=GOLD; px[_cx-3,_cy]=GOLD; draw.line([_cx,_cy,_cx-2,_cy+2],fill=B,width=1); draw.line([_cx,_cy,_cx,_cy-3],fill=GOLD,width=1); draw.line([_cx-4,_cy+5,_cx-5,_cy+7],fill=GOLD,width=1); draw.line([_cx+4,_cy+5,_cx+5,_cy+7],fill=GOLD,width=1)
        elif item_type=="plant_cactus":  draw.rectangle([_cx+2,_cy-5,_cx+5,_cy-2],fill=(50,140,50,255)); draw.line([_cx+3,_cy-5,_cx+3,_cy-2],fill=(80,180,80,255),width=1); draw.rectangle([_cx-5,_cy-4,_cx-2,_cy-1],fill=(50,140,50,255)); draw.line([_cx-4,_cy-4,_cx-4,_cy-1],fill=(80,180,80,255),width=1); draw.rectangle([_cx-2,_cy-8,_cx+2,_cy+3],fill=(50,140,50,255)); draw.line([_cx-1,_cy-8,_cx-1,_cy+3],fill=(80,180,80,255),width=1); draw.line([_cx-2,_cy-6,_cx-4,_cy-7],fill=W,width=1); draw.line([_cx+2,_cy-4,_cx+4,_cy-5],fill=W,width=1); draw.line([_cx,_cy-8,_cx,_cy-10],fill=W,width=1); draw.polygon([(_cx-4,_cy+1),(_cx+4,_cy+1),(_cx+3,_cy+8),(_cx-3,_cy+8)],fill=(160,100,60,255)); draw.rectangle([_cx-4,_cy,_cx+4,_cy+2],fill=(200,120,70,255)); draw.line([_cx-4,_cy,_cx+4,_cy],fill=B,width=1); draw.line([_cx-4,_cy,_cx-3,_cy+8],fill=B,width=1); draw.line([_cx+4,_cy,_cx+3,_cy+8],fill=B,width=1); draw.line([_cx-3,_cy+8,_cx+3,_cy+8],fill=B,width=1)
        elif item_type=="plant_leaf":    draw.line([_cx,_cy-4,_cx,_cy+3],fill=(40,120,40,255),width=2); draw.ellipse([_cx-6,_cy-8,_cx,_cy-2],fill=(80,190,80,255)); draw.line([_cx-3,_cy-8,_cx-3,_cy-2],fill=(60,160,60,255),width=1); draw.ellipse([_cx,_cy-9,_cx+6,_cy-3],fill=(80,190,80,255)); draw.line([_cx+3,_cy-9,_cx+3,_cy-3],fill=(60,160,60,255),width=1); draw.ellipse([_cx-1,_cy-9,_cx+1,_cy-5],fill=(140,220,100,255)); draw.polygon([(_cx-4,_cy+1),(_cx+4,_cy+1),(_cx+3,_cy+8),(_cx-3,_cy+8)],fill=(80,140,200,255)); draw.rectangle([_cx-4,_cy,_cx+4,_cy+2],fill=(110,170,230,255)); draw.line([_cx-3,_cy+4,_cx+3,_cy+4],fill=W,width=1); draw.line([_cx-4,_cy,_cx+4,_cy],fill=B,width=1); draw.line([_cx-4,_cy,_cx-3,_cy+8],fill=B,width=1); draw.line([_cx+4,_cy,_cx+3,_cy+8],fill=B,width=1); draw.line([_cx-3,_cy+8,_cx+3,_cy+8],fill=B,width=1)
        elif item_type=="bouquet_lavender": draw.polygon([(_cx-5,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx-3,_cy+8)],fill=(220,205,240,255)); draw.polygon([(_cx,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx+1,_cy+8)],fill=(240,230,255,255)); draw.line([_cx,_cy-5,_cx+1,_cy+8],fill=(220,205,240,255),width=1); draw.line([_cx,_cy-5,_cx,_cy-7],fill=(40,120,30,255),width=1); draw.ellipse([_cx-6,_cy-9,_cx-2,_cy-6],fill=(70,170,50,255)); draw.ellipse([_cx+2,_cy-8,_cx+6,_cy-5],fill=(70,170,50,255)); draw.ellipse([_cx-6,_cy-14,_cx-1,_cy-9],fill=(255,140,170,255)); draw.ellipse([_cx-5,_cy-13,_cx-2,_cy-10],fill=(255,210,225,255)); draw.ellipse([_cx+1,_cy-13,_cx+6,_cy-8],fill=(230,90,130,255)); draw.ellipse([_cx+2,_cy-12,_cx+5,_cy-9],fill=(255,180,200,255)); draw.ellipse([_cx-3,_cy-15,_cx+3,_cy-9],fill=(210,50,90,255)); draw.ellipse([_cx-2,_cy-14,_cx+2,_cy-10],fill=(255,120,150,255)); px[_cx,_cy-12]=YELLOW
        elif item_type=="bouquet_kraft":    draw.polygon([(_cx-5,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx-3,_cy+8)],fill=(210,175,120,255)); draw.polygon([(_cx,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx+1,_cy+8)],fill=(235,200,145,255)); draw.line([_cx,_cy-5,_cx+1,_cy+8],fill=(210,175,120,255),width=1); draw.line([_cx-4,_cy-1,_cx+3,_cy-1],fill=(190,155,100,255),width=1); draw.line([_cx-3,_cy+2,_cx+2,_cy+2],fill=(190,155,100,255),width=1); draw.line([_cx-3,_cy+5,_cx+2,_cy+5],fill=(190,155,100,255),width=1); draw.line([_cx,_cy-5,_cx,_cy-7],fill=(40,120,30,255),width=1); draw.ellipse([_cx-6,_cy-9,_cx-2,_cy-6],fill=(60,160,40,255)); draw.ellipse([_cx+2,_cy-8,_cx+6,_cy-5],fill=(60,160,40,255)); draw.ellipse([_cx-6,_cy-14,_cx-1,_cy-9],fill=YELLOW); px[_cx-3,_cy-11]=(100,60,20,255); draw.ellipse([_cx+1,_cy-13,_cx+6,_cy-8],fill=YELLOW); px[_cx+3,_cy-10]=(100,60,20,255); draw.ellipse([_cx-3,_cy-15,_cx+3,_cy-9],fill=(255,220,30,255)); px[_cx,_cy-12]=(120,70,20,255)
        elif item_type=="bouquet_green":    draw.polygon([(_cx-5,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx-3,_cy+8)],fill=(190,230,190,255)); draw.polygon([(_cx,_cy-5),(_cx+5,_cy-5),(_cx+3,_cy+8),(_cx+1,_cy+8)],fill=(215,245,215,255)); draw.line([_cx,_cy-5,_cx+1,_cy+8],fill=(190,230,190,255),width=1); draw.line([_cx-4,_cy-3,_cx-1,_cy],fill=(170,215,170,255),width=1); draw.line([_cx,_cy-1,_cx+3,_cy+2],fill=(170,215,170,255),width=1); draw.line([_cx-3,_cy+3,_cx,_cy+6],fill=(170,215,170,255),width=1); draw.line([_cx,_cy-5,_cx,_cy-7],fill=(40,120,30,255),width=1); draw.ellipse([_cx-6,_cy-9,_cx-2,_cy-6],fill=(70,170,50,255)); draw.ellipse([_cx+2,_cy-8,_cx+6,_cy-5],fill=(70,170,50,255)); draw.ellipse([_cx-6,_cy-14,_cx-1,_cy-9],fill=(255,140,170,255)); px[_cx-4,_cy-12]=YELLOW; draw.ellipse([_cx+1,_cy-13,_cx+6,_cy-8],fill=(180,100,220,255)); draw.ellipse([_cx+2,_cy-12,_cx+5,_cy-9],fill=(210,160,240,255)); px[_cx+3,_cy-11]=YELLOW; draw.ellipse([_cx-3,_cy-15,_cx+3,_cy-9],fill=YELLOW); px[_cx,_cy-12]=(180,120,20,255)
        elif item_type=="cake": draw.ellipse([_cx-5,_cy+4,_cx+5,_cy+7],fill=(220,220,220,255)); draw.rectangle([_cx-4,_cy+1,_cx+4,_cy+5],fill=(220,180,120,255)); draw.line([_cx-4,_cy+2,_cx+4,_cy+2],fill=(255,245,220,255),width=1); draw.ellipse([_cx-4,_cy-2,_cx+4,_cy+2],fill=(255,245,220,255)); draw.ellipse([_cx-2,_cy-5,_cx+2,_cy-2],fill=(210,50,50,255)); draw.rectangle([_cx-1,_cy-6,_cx+1,_cy-5],fill=(60,160,60,255))
        elif item_type=="guitar":   draw.rectangle([_cx-2,_cy-7,_cx+2,_cy-5],fill=(140,85,25,255),outline=B); draw.point([(_cx-3,_cy-6),(_cx+3,_cy-6)],fill=(190,190,190,255)); draw.rectangle([_cx-1,_cy-5,_cx+1,_cy+2],fill=(195,145,60,255),outline=B); draw.line([_cx-1,_cy-2,_cx+1,_cy-2],fill=(230,215,185,255),width=1); draw.ellipse([_cx-3,_cy+1,_cx+3,_cy+5],fill=(190,115,35,255),outline=B); draw.ellipse([_cx-5,_cy+4,_cx+5,_cy+12],fill=(190,115,35,255),outline=B); draw.ellipse([_cx-2,_cy+7,_cx+2,_cy+10],fill=(90,50,15,255)); draw.rectangle([_cx-3,_cy+11,_cx+3,_cy+12],fill=(130,75,25,255))
        elif item_type=="switch":    draw.rectangle([_cx-6,_cy-2,_cx+6,_cy+3],fill=(50,50,55,255),outline=B); draw.rectangle([_cx-6,_cy-2,_cx-4,_cy+3],fill=(210,35,35,255),outline=B); draw.rectangle([_cx+4,_cy-2,_cx+6,_cy+3],fill=(25,85,215,255),outline=B); draw.rectangle([_cx-3,_cy-1,_cx+3,_cy+2],fill=(15,15,20,255)); draw.rectangle([_cx-2,_cy-1,_cx+2,_cy+1],fill=(80,130,210,255)); draw.point([_cx-5,_cy],fill=(190,30,30,255)); draw.point([_cx+5,_cy+1],fill=(20,65,190,255)); draw.point([_cx+5,_cy-1],fill=(30,170,30,255))
        elif item_type=="gameboy":   draw.rectangle([_cx-3,_cy-8,_cx+3,_cy+6],fill=(185,180,170,255),outline=B); draw.rectangle([_cx-3,_cy-8,_cx+3,_cy-2],fill=(160,155,145,255)); draw.rectangle([_cx-2,_cy-7,_cx+2,_cy-3],fill=(125,160,95,255),outline=(90,120,65,255)); draw.rectangle([_cx-1,_cy-6,_cx+1,_cy-4],fill=(85,115,65,255)); draw.line([_cx-2,_cy,_cx,_cy],fill=(80,75,70,255),width=1); draw.line([_cx-1,_cy-1,_cx-1,_cy+1],fill=(80,75,70,255),width=1); draw.point([_cx+2,_cy],fill=(190,35,65,255)); draw.point([_cx+1,_cy+1],fill=(190,35,65,255)); draw.point([_cx-1,_cy+3],fill=(120,115,108,255)); draw.point([_cx+1,_cy+3],fill=(120,115,108,255)); draw.point([(_cx+1,_cy+5),(_cx+2,_cy+5),(_cx+3,_cy+5)],fill=(155,150,140,255))
        elif item_type=="drumstick":   draw.rectangle([_cx-1,_cy+1,_cx+1,_cy+8],fill=(240,228,205,255)); draw.ellipse([_cx-2,_cy+6,_cx+2,_cy+10],fill=(240,228,205,255),outline=(200,180,145,255)); draw.ellipse([_cx-6,_cy-13,_cx+4,_cy-3],fill=(200,100,35,255)); draw.ellipse([_cx-3,_cy-7,_cx+5,_cy+2],fill=(200,100,35,255)); draw.ellipse([_cx-4,_cy-11,_cx,_cy-6],fill=(225,135,60,255)); draw.point([(_cx-3,_cy-10)],fill=W)
        elif item_type=="handbag_a":     draw.line([_cx-2,_cy,_cx-2,_cy+4],fill=(155,105,48,255),width=1); draw.line([_cx+2,_cy,_cx+2,_cy+4],fill=(155,105,48,255),width=1); draw.line([_cx-2,_cy,_cx+2,_cy],fill=(155,105,48,255),width=1); draw.rectangle([_cx-4,_cy+4,_cx+4,_cy+11],fill=(228,192,150,255)); draw.rectangle([_cx-1,_cy+4,_cx+1,_cy+5],fill=(210,175,58,255)); draw.line([_cx-4,_cy+9,_cx+4,_cy+9],fill=(200,163,120,255),width=1)
        elif item_type=="handbag_b":     draw.line([_cx-2,_cy+1,_cx-2,_cy+4],fill=(155,105,48,255),width=1); draw.line([_cx+2,_cy+1,_cx+2,_cy+4],fill=(155,105,48,255),width=1); draw.line([_cx-2,_cy+1,_cx+2,_cy+1],fill=(155,105,48,255),width=1); draw.rectangle([_cx-4,_cy+4,_cx+4,_cy+8],fill=(240,178,198,255)); draw.ellipse([_cx-4,_cy+6,_cx+4,_cy+12],fill=(240,178,198,255)); draw.line([_cx-3,_cy+4,_cx+3,_cy+4],fill=(215,148,170,255),width=1); draw.point([(_cx-1,_cy+4),(_cx+1,_cy+4)],fill=(195,128,150,255))
        elif item_type=="handbag_c":     draw.line([_cx-2,_cy,_cx-2,_cy+4],fill=(140,90,35,255),width=1); draw.line([_cx+2,_cy,_cx+2,_cy+4],fill=(140,90,35,255),width=1); draw.line([_cx-2,_cy,_cx+2,_cy],fill=(140,90,35,255),width=1); draw.rectangle([_cx-5,_cy+4,_cx+5,_cy+10],fill=(188,130,68,255)); draw.ellipse([_cx-5,_cy+3,_cx+5,_cy+7],fill=(162,105,45,255)); draw.ellipse([_cx-1,_cy+5,_cx+1,_cy+7],fill=(210,175,58,255)); draw.line([_cx-4,_cy+5,_cx-4,_cy+9],fill=(168,112,52,255),width=1); draw.line([_cx+4,_cy+5,_cx+4,_cy+9],fill=(168,112,52,255),width=1)
...
_anim_gen = generate_sticker
_ALL_MOODS = ALL_MOODS
