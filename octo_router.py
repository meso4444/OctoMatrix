...
{SYS_PREFIX} Please strictly follow the [SOP] above to reply."""
    ...
    def _send_help(self, msg: MCMessage):
        ...
        help_text += "• <code>/inspect [name]</code>: Assign the current Agent to enter the target window for deep inspection (including log capture and SOP analysis).\n\n"
        ...
        help_text += "• <code>/fix [name]</code>: Execute a hard reset and prompt recovery (Kill Window & Resume) to fix a stuck or crashed Agent window.\n"
